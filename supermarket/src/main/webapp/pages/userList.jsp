    ...
    <section class="publicMian ">
        ...
        <div class="right">
            ...
            <div class="search">
                ...
                <a href=""${pageContext.request.contextPath}/pages/">添加用户</a>
            </div>
            <!--用户-->
                ...
                <c:if test="${pager.lists!=null}">
                    <c:forEach items="${pager.lists}" var="item">
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/pages/userView.html"><img src="${pageContext.request.contextPath}/pages/img/read.png" alt="查看" title="查看"/></a>
                                <a href="${pageContext.request.contextPath}/pages/userUpdate.html"><img src="${pageContext.request.contextPath}/pages/img/xiugai.png" alt="修改" title="修改"/></a>
